...
- **Library components first.** Buttons are the Figma Button via `ui/Cta.jsx`. The primary action uses the `gradient` variant, the signature Billease button. Never propose a restyled button.
